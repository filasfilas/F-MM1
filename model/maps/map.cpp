...
//to do load mazes
	...
	_mazelist.push_back(new Maze06(gm));
	_mazelist.push_back(new Maze07(gm));
	_mazelist.push_back(new Maze08(gm));
	_mazelist.push_back(new Maze09(gm));
	_mazelist.push_back(new Maze10(gm));
	_mazelist.push_back(new Maze11(gm));
	_mazelist.push_back(new Maze12(gm));
	_mazelist.push_back(new Maze13(gm));
	_mazelist.push_back(new Maze14(gm));
	_mazelist.push_back(new Maze15(gm));
	_mazelist.push_back(new Maze16(gm));
	_mazelist.push_back(new Maze17(gm));
	_mazelist.push_back(new Maze18(gm));
    _mazelist.push_back(new Maze19(gm));
	_mazelist.push_back(new Maze20(gm));
	_mazelist.push_back(new Maze21(gm));
	_mazelist.push_back(new Maze22(gm));
	_mazelist.push_back(new Maze23(gm));
	_mazelist.push_back(new Maze24(gm));
	_mazelist.push_back(new Maze25(gm));
